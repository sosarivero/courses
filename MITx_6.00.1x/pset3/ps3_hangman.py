...
def isWordGuessed(secretWord, lettersGuessed):
    ...
    for letter in secretWord:
        # If one letter is missing from the guesses, immediately return.
...
def getGuessedWord(secretWord, lettersGuessed):
    ...
    for letter in secretWord:
        if letter in lettersGuessed:
            ...
            # Added padding for usability as recommended.
            progress += " _ "
    return progress
...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    while isWordGuessed(secretWord, letters_guessed) is False and lifes > 0:
        print("-"*13)
        print("You have %i guesses left" % lifes)
